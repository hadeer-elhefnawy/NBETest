        ...
        <div class="container pt-5">
            <div class="row px-5">
                ...
                <div class="col-12 text-center my-4">
                   <a href="{{url('/Reports')}}" class="btn btn-info mx-3 text-white"><i class="fas fa-backward"></i>   Back</a>
                   <a href="{{url('/Online')}}" class="btn btn-primary mx-3">Next   <i class="fas fa-forward"></i></a>
                </div>
