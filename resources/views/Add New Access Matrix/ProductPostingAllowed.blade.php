    ...
    <section id="header pt-5 mt-5">
        <div class="container pt-5">
            <div class="row px-5">
                ...
                <div class="col-md-6 text-center mb-3">
                    <a href="" class="btn btn-success float-end my-3"><i class="fas fa-plus"></i>  Add Product Posting</a>
                </div>
                ...
                <div class="col-12 text-center my-4">
                    <a href="{{url('/WebBranch')}}" class="btn btn-info mx-3 text-white"><i class="fas fa-backward"></i>   Back</a>
                    <a href="{{url('/ProductAccessAllowed')}}" class="btn btn-primary mx-3">Next   <i class="fas fa-forward"></i></a>
                 </div>
             </div>
         </div>
     </section>
