        ...
        <div class="container pt-5">
            <div class="row px-5">
                ...
                <div class="col-12 mb-3">
                    <label for="ProdDescription" class="form-label">Group Description</label>
                    <textarea class="form-control" id="ProdDescription" rows="3"></textarea>
                </div>

                <div class="col-12 text-center my-4">
                    <a href="{{url('/ProductAccessAllowed')}}" class="btn btn-info mx-3 text-white"><i class="fas fa-backward"></i>   Back</a>
                    <a href="{{url('/NodeGl')}}" class="btn btn-primary mx-3">Next   <i class="fas fa-forward"></i></a>
                 </div>
             </div>
         </div>
     </section>
