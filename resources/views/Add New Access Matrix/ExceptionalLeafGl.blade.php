    ...
    <section id="header pt-5 mt-5">
        <div class="container pt-5">
            <div class="row px-5">
                ...
                <div class="col-md-6 text-center mb-3">
                    <a href="" class="btn btn-success float-end my-3"><i class="fas fa-plus"></i>  Add Exceptional Leaf Gl</a>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <label for="ExceptionalGl" class="form-label">Exceptional Leaf Gl</label>
                    <input type="text" class="form-control" id="NodeGl" placeholder="Node Gl">
                </div>
                <div class="col-12 mb-3">
                    <label for="LeafGlDesc" class="form-label">Leaf Gl Description</label>
                    <textarea class="form-control" id="LeafGlDesc" rows="3"></textarea>
                </div>
                <div class="col-12 text-center my-4">
                    <a href="{{url('/NodeGl')}}" class="btn btn-info mx-3 text-white"><i class="fas fa-backward"></i>   Back</a>
                    <a href="{{url('/home')}}" class="btn btn-primary mx-3">Next   <i class="fas fa-forward"></i></a>
                 </div>
             </div>
         </div>
     </section>
